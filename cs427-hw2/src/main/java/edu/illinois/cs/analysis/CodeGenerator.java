...
public class CodeGenerator extends VoidVisitorAdapter
{
	...
	public void visit(ClassOrInterfaceDeclaration n, Object arg) {
		...
		if (!n.isInterface() & !n.isAbstract()) {
			...
			VariableDeclarator varDec2 = new VariableDeclarator().setType("int").setName("len").setInitializer(new MethodCallExpr(temp, "length"));
			...
			BinaryExpr condition = new BinaryExpr(name, 
													value, 
